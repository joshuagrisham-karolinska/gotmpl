...
Options:
  ...
  --path <path>     HTTP path [default: /gotmpl].`
	...
	// http.HandleFunc("POST "+path, postGotmpl) //TODO this is not working?
	http.HandleFunc("/", postGotmpl)
	log.Fatal(http.ListenAndServe(":"+port, nil))

}

func postGotmpl(w http.ResponseWriter, r *http.Request) {
